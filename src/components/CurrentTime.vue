...
<template>
  <div
    class="bg-gradient-to-r from-ocean-600 to-ocean-800 text-gray rounded-lg p-6 shadow-lg"
  >
    <div class="text-center">
      <h2 class="text-sm font-medium opacity-90 mb-2">Hong Kong Time</h2>
      <div class="text-4xl font-bold mb-2 font-mono">
        {{ formattedTimeNoSeconds }}
      </div>
      <div class="text-lg opacity-90">{{ formattedDate }}</div>
